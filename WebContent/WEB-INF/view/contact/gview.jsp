		...
		<hr class="sidebar-divider">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">그룹</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
  
<form name="form1" method="post">
 <table class="table table-bordered" id="contact" width="20%" cellspacing="0">
    <thead>
 <tr>
   <td colspan="4"> 
...
<a href="contact/gupdate.do?gnum=${gdto.gnum }" class="btn btn-secondary btn-sm">수정</a>
<a href="contact/gdelete.do?gnum=${gdto.gnum }" id="delete" class="btn btn-secondary btn-sm">삭제 </a>
 </div>
          </div>
          </div>
        <!-- /.container-fluid -->
