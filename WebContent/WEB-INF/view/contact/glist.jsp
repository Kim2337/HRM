...
<title>HRM Project Net - 연락처 그룹관리</title>
  ...
  <div id="wrapper">
	...
	<br>
	 ...
	 <hr class="sidebar-divider">
      ...
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="/HRMProjectMain/jsp/notice/list?now=1">
          <i class="fas fa-fw"></i>
          <span>공지사항</span>
        </a>
      </li>
...
<!-- 버튼 -->
              <button id="gadd" class="btn btn-secondary btn-sm">그룹추가</button>
              </h6>
            </div>
            <div class="card-body">
