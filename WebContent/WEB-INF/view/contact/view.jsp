...
<form name="form" method="post">
 <div  class="container" width="20%" cellspacing="0">
  <div class="card-box">
<img src="${pageContext.request.contextPath}/resources/img/Contact.PNG" class="photo">
  <div class="info">
  ...
  <div class="languages">${dto.compname}, ${dto.level} </div>
   <!-- 구분선 -->  <div class="divider"></div>
     ...
     <img src="${pageContext.request.contextPath}/resources/img/Phone.png" width="20px" height="15px">&nbsp;${dto.phonenum}
     <br><img src="${pageContext.request.contextPath}/resources/img/Email.png" width="20px" height="15px">&nbsp;${dto.email}
    ...
    <a href="contact/delete.do?num=${dto.num }" id="delete"
